...
Pod::Spec.new do |s|
  s.name             = 'YFPSMonitor'
  s.version          = '0.1.0'
  s.summary          = 'A short description of YFPSMonitor.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/eaffy/YFPSMonitor'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'eaffy' => 'yifei239@126.com' }
  s.source           = { :git => 'https://github.com/eaffy/YFPSMonitor.git', :tag => s.version.to_s }
